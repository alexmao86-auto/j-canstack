...
public class RequestDownload extends BaseService {
	...
	public DataFormatIdentifier normalize_data_format_identifier(DataFormatIdentifier dfi) throws Exception {
		if (dfi == null) {
	...
	public Request make_request(MemoryLocation memory_location, DataFormatIdentifier dfi) throws Exception {
		dfi = this.normalize_data_format_identifier(dfi);
